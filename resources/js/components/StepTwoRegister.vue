  ...
  <div @click.stop="cardClick" class="card bg-white w-11/12 p-4 rounded-md shadow-md">
    <div class="mb-4">
      ...
      <div class="bg-gray-100 w-full rounded-lg overflow-hidden">
        <input v-model="form.tel" type="tel" placeholder="Phone number" id="tel" autocomplete="off" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="">
      </div>
    </div>

    <div class="mb-4">
      <label for="contry" class="sr-only">Pays</label>
      <div class="bg-gray-100 w-full rounded-lg overflow-hidden">
        <input v-model="form.contry" type="text" placeholder="Your Contry" id="contry" autocomplete="off" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="">
      </div>
    </div>
    ...
    <div class="mb-4">
      ...
      <div class="bg-gray-100 w-full rounded-lg overflow-hidden">
        <input v-model="form.city" type="text" placeholder="Your city" id="city" autocomplete="off" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="">
      </div>
    </div>
    ...
    <div class="w-full flex justify-between items-center">
      <button @click="prev" class="bg-orange-600 hover:bg-orange-700 transition-all  text-white px-4 py-3 rounded w-4/12  font-medium ">Prev</button>
      <button @click="send" type="submit" class="bg-orange-600 hover:bg-orange-700 transition-all  text-white px-4 py-3 rounded w-4/12  font-medium ">Sign in</button>
    </div>
  </div>
</template>
